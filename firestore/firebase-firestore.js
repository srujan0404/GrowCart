  ...
  if ("number" != typeof e && e && !e.fa) {
    ...
    if (t && t[Q]) Ua(t.i, e);
      ...
      t.removeEventListener
        ...
        (n = bb(t))
          ? (Ua(n, e), 0 == n.h && ((n.src = null), (t[j] = null)))
          : Ka(e);
    }
  }
}
    ...
    try {
      if (e == this.g)
        e: {
          ...
          if (
            !(3 > d) &&
            (3 != d || M || (this.g && (this.h.h || this.g.ja() || mc(this.g))))
          ) {
...
function Yd(e, t) {
  ...
  if (30 < e.g.length) {
    ...
    for (var n = ve, i = t; 0 >= i.X(e); ) (n = be(n)), (i = be(i));
    var s = Z$1(n, 1),
      o = Z$1(i, 1);
...
((m = T.prototype).ea = function () {
  ...
  (m.R = function (e) {
    ...
    if (0 > this.X(Se) && 0 > e.X(Se)) return U$1(this.ea() * e.ea());
...
function __PRIVATE_queryToTarget(e) {
  ...
  return (
    t.Ie ||
      (t.Ie = __PRIVATE__queryToTarget(t, __PRIVATE_queryNormalizedOrderBy(e))),
    t.Ie
  );
}
...
class __PRIVATE_DocumentWatchChange {
  constructor(e, t, n, i) {
    (this.ge = e), (this.removedTargetIds = t), (this.key = n), (this.pe = i);
  }
}
...
class __PRIVATE_TargetState {
  constructor() {
    (this.we = 0),
      ...
      (this.be = ByteString.EMPTY_BYTE_STRING),
      (this.De = !1),
      (this.Ce = !0);
  }
  get current() {
...
class __PRIVATE_WatchChangeAggregator {
  ...
  ot(e, t) {
    ...
    return (
      n.forEach((n) => {
        ...
        e.mightContain(o) || (this.je(t, n, null), i++);
      }),
      i
    );
  }
  _t(e) {
    ...
    this.Ke.forEach((n, i) => {
      ...
      if (s) {
        if (n.current && __PRIVATE_targetIsDocumentTarget(s.target)) {
          ...
          null !== this.$e.get(t) ||
            this.ut(i, t) ||
            this.je(i, t, MutableDocument.newNoDocument(t, e));
        }
        n.Fe && (t.set(i, n.xe()), n.Oe());
      }
    });
    ...
    const i = new RemoteEvent(e, t, this.We, this.$e, n);
    return (
      (this.$e = __PRIVATE_mutableDocumentMap()),
      (this.Ue = __PRIVATE_documentTargetMap()),
      (this.We = new SortedMap(__PRIVATE_primitiveComparator)),
  ...
  ze(e, t) {
    ...
    this.Je(e).Ne(t.key, n),
      (this.$e = this.$e.insert(t.key, t)),
      (this.Ue = this.Ue.insert(t.key, this.ct(t.key).add(e)));
  }
  je(e, t, n) {
    if (!this.Ye(e)) return;
    const i = this.Je(e);
    this.ut(e, t) ? i.Ne(t, 1) : i.Be(t),
      (this.Ue = this.Ue.insert(t, this.ct(t).delete(e))),
      n && (this.$e = this.$e.insert(t, n));
  }
  removeTarget(e) {
    this.Ke.delete(e);
  }
...
function __PRIVATE_fromDbMutationBatch(e, t) {
  ...
  const i = t.mutations.map((t) => __PRIVATE_fromMutation(e.ht, t)),
...
function __PRIVATE_toDbTarget(e, t) {
  ...
  s = __PRIVATE_targetIsDocumentTarget(t.target)
    ? __PRIVATE_toDocumentsTarget(e.ht, t.target)
    : __PRIVATE_toQueryTarget(e.ht, t.target);
...
function __PRIVATE_fromDbDocumentOverlay(e, t) {
  return new Overlay(
    t.largestBatchId,
    __PRIVATE_fromMutation(e.ht, t.overlayMutation)
  );
}
...
class __PRIVATE_FirestoreIndexValueWriter {
  ...
  Tt(e, t) {
    if ("nullValue" in e) this.At(t, 5);
    else if ("booleanValue" in e) this.At(t, 10), t.Rt(e.booleanValue ? 1 : 0);
      ...
      isNaN(n)
        ? this.At(t, 13)
        : (this.At(t, 15), __PRIVATE_isNegativeZero(n) ? t.Rt(0) : t.Rt(n));
    } else if ("timestampValue" in e) {
      const n = e.timestampValue;
      this.At(t, 20),
        "string" == typeof n
          ? t.Vt(n)
          : (t.Vt(`${n.seconds || ""}`), t.Rt(n.nanos || 0));
    } else if ("stringValue" in e) this.ft(e.stringValue, t), this.gt(t);
    else if ("bytesValue" in e)
      this.At(t, 30),
        t.yt(__PRIVATE_normalizeByteString(e.bytesValue)),
        this.gt(t);
    else if ("referenceValue" in e) this.wt(e.referenceValue, t);
      ...
      "mapValue" in e
        ? __PRIVATE_isMaxValue(e)
          ...
          : (this.St(e.mapValue, t), this.gt(t))
        : "arrayValue" in e
        ? (this.bt(e.arrayValue, t), this.gt(t))
        : fail();
  }
  ft(e, t) {
...
__PRIVATE_FirestoreIndexValueWriter.Ct =
...
class __PRIVATE_TargetIndexMatcher {
  ...
  nn(e) {
    ...
    let i = new Set(),
      s = 0,
      o = 0;
    for (; s < n.length && this.rn(n[s]); ++s)
      i = i.add(n[s].fieldPath.canonicalString());
    if (s === n.length) return !0;
    if (void 0 !== this.tn) {
      if (!i.has(this.tn.field.canonicalString())) {
        const e = n[s];
        if (!this.sn(this.tn, e) || !this.on(this.Xt[o++], e)) return !1;
      }
      ++s;
    }
    for (; s < n.length; ++s) {
      const e = n[s];
      if (o >= this.Xt.length || !this.on(this.Xt[o++], e)) return !1;
    }
    return !0;
  }
  _n() {
...
class __PRIVATE_IndexedDbIndexManager {
  ...
  createTargetIndexes(e, t) {
    return PersistencePromise.forEach(this.ln(t), (t) =>
      ...
      if (i) {
        ...
        return PersistencePromise.forEach(s, (s, o) => {
          ...
          const u = (function __PRIVATE_targetGetArrayValues(e, t) {
            ...
            m = this.Pn(s, o, h),
            f = this.In(s, o, l),
            g = this.dn(s.indexId, u, d, _.inclusive, m, h.inclusive, f);
  ...
  dn(e, t, n, i, s, o, u) {
    const l = (null != t ? t.length : 1) * Math.max(n.length, s.length),
      ...
      h = [];
    for (let d = 0; d < l; ++d) {
      const l = t ? this.Tn(t[d / _]) : vt,
        m = this.En(e, l, n[d % _], i),
        f = this.An(e, l, s[d % _], o),
  ...
  hn(e, t) {
    ...
    return this.getFieldIndexes(e, i).next((e) => {
      let t = null;
      for (const i of e)
        n.nn(i) && (!t || i.fields.length > t.fields.length) && (t = i);
      return t;
    });
  }
  getIndexType(e, t) {
  ...
  Rn(e, t) {
    ...
    for (const i of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      const s = n.Yt(i.kind);
      __PRIVATE_FirestoreIndexValueWriter.Ct.dt(e, s);
    }
    return n.zt();
  }
  Tn(e) {
    const t = new __PRIVATE_IndexByteEncoder();
    return __PRIVATE_FirestoreIndexValueWriter.Ct.dt(e, t.Yt(0)), t.zt();
  }
  Vn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return (
      __PRIVATE_FirestoreIndexValueWriter.Ct.dt(
  ...
  In(e, t, n) {
    ...
    for (const o of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e = n[s++];
      for (const n of i)
        if (this.mn(t, o.fieldPath) && isArray(e)) i = this.fn(i, o, e);
        else {
          const t = n.Yt(o.kind);
  ...
  fn(e, t, n) {
    ...
    for (const e of n.arrayValue.values || [])
      for (const n of i) {
        ...
        i.seed(n.zt()),
          __PRIVATE_FirestoreIndexValueWriter.Ct.dt(e, i.Yt(t.kind)),
          s.push(i);
      }
    return s;
  }
    ...
    if (null != s) {
      ...
      if (isArray(o))
        for (const s of o.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Tn(s), i));
    } else n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, vt, i));
    return n;
  }
  Sn(e, t, n, i, s) {
    __PRIVATE_logDebug(
  ...
  createRange(e, t, n) {
    ...
    for (const s of n) {
      ...
      if (0 === n) i[0] = e.Zt();
      else if (n > 0 && o < 0) i.push(s), i.push(s.Zt());
      else if (o > 0) break;
    }
    i.push(t);
    const s = [];
    for (let e = 0; e < i.length; e += 2) {
      if (this.Cn(i[e], i[e + 1])) return [];
      const t = [
          i[e].indexId,
          this.uid,
          i[e].arrayValue,
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.ln(t), (t) =>
      this.hn(e, t).next((e) => e || fail())
...
class __PRIVATE_IndexedDbMutationQueue {
    ...
    return o.add({}).next((u) => {
      ...
      const l = new MutationBatch(u, t, n, i),
        _ = (function __PRIVATE_toDbMutationBatch(e, t, n) {
          const i = n.baseMutations.map((t) => toMutation(e.ht, t)),
            s = n.mutations.map((t) => toMutation(e.ht, t));
          return {
            userId: t,
            batchId: n.batchId,
  ...
  Fn(e, t) {
    return this.vn[t]
      ? PersistencePromise.resolve(this.vn[t])
  ...
  getAllMutationBatchesAffectingDocumentKeys(e, t) {
    ...
    return (
      ...
      PersistencePromise.waitFor(i).next(() => this.Mn(e, n))
    );
  }
...
class __PRIVATE_IndexedDbTargetCache {
  ...
  addTargetData(e, t) {
    return this.Qn(e, t).next(() =>
      this.kn(e).next(
        (n) => ((n.targetCount += 1), this.Kn(t, n), this.qn(e, n))
      )
    );
  }
...
class __PRIVATE_LruScheduler {
  ...
  jn(e) {
    __PRIVATE_logDebug(
      ...
      (this.zn = this.asyncQueue.enqueueAfterDelay(
...
class __PRIVATE_LruGarbageCollectorImpl {
  ...
  nthSequenceNumber(e, t) {
    ...
    return this.Hn.forEachTarget(e, (e) => n.Gn(e.sequenceNumber))
      .next(() => this.Hn.Yn(e, (e) => n.Gn(e)))
      .next(() => n.maxValue);
  }
  removeTargets(e, t, n) {
...
class __PRIVATE_IndexedDbLruDelegateImpl {
  ...
  removeOrphanedDocuments(e, t) {
    const n = this.db.getRemoteDocumentCache().newChangeBuffer(),
      i = [];
    let s = 0;
    return this.er(e, (o, u) => {
      if (u <= t) {
        const t = this.tr(e, o).next((t) => {
          if (!t)
            return (
              s++,
              n.getEntry(e, o).next(
  ...
  ir(e, t) {
    ...
    return __PRIVATE_remoteDocumentsStore(e)
      .Z(
        ...
        (e, i) => {
          n = { document: this.rr(t, i), size: __PRIVATE_dbDocumentSize(i) };
        }
      )
      .next(() => n);
  }
...
class __PRIVATE_IndexedDbRemoteDocumentChangeBuffer extends RemoteDocumentChangeBuffer {
  ...
  applyChanges(e) {
    ...
    return (
      this.changes.forEach((s, o) => {
        const u = this.cr.get(s);
        if (
          (t.push(this.ur.removeEntry(e, s, u.readTime)), o.isValidDocument())
        ) {
          const l = __PRIVATE_toDbRemoteDocument(this.ur.serializer, o);
          i = i.add(s.path.popLast());
          const _ = __PRIVATE_dbDocumentSize(l);
          (n += _ - u.size), t.push(this.ur.addEntry(e, s, l));
        } else if (((n -= u.size), this.trackRemovals)) {
          const n = __PRIVATE_toDbRemoteDocument(
            this.ur.serializer,
            o.convertToNoDocument(SnapshotVersion.min())
          );
          t.push(this.ur.addEntry(e, s, n));
        }
      }),
      i.forEach((n) => {
        t.push(this.ur.indexManager.addToCollectionParentIndex(e, n));
      }),
      t.push(this.ur.updateMetadata(e, n)),
  ...
  getFromCache(e, t) {
    return this.ur
      ...
      .next(
        (e) => (
          this.cr.set(t, { size: e.size, readTime: e.document.readTime }),
          e.document
        )
      );
  }
  getAllFromCache(e, t) {
    return this.ur._r(e, t).next(
      ({ documents: e, ar: t }) => (
        t.forEach((t, n) => {
          this.cr.set(t, { size: n, readTime: e.get(t).readTime });
        }),
        e
      )
    );
...
class __PRIVATE_MemoryDocumentOverlayCache {
  ...
  It(e, t, n) {
    ...
    if (null !== i) {
      const e = this.Pr.get(i.largestBatchId).delete(n.key);
      this.Pr.set(i.largestBatchId, e);
    }
    this.overlays = this.overlays.insert(n.key, new Overlay(t, n));
    let s = this.Pr.get(t);
    void 0 === s && ((s = __PRIVATE_documentKeySet()), this.Pr.set(t, s)),
      this.Pr.set(t, s.add(n.key));
  }
}
class __PRIVATE_ReferenceSet {
  ...
  mr(e) {
    const t = new DocumentKey(new ResourcePath([])),
      ...
      s = [];
    return (
      this.Tr.forEachInRange([n, i], (e) => {
        this.Rr(e), s.push(e.key);
      }),
      s
    );
  }
...
class __PRIVATE_DocReference {
  ...
  static dr(e, t) {
    return (
      ...
      __PRIVATE_primitiveComparator(e.yr, t.yr)
    );
  }
  static Er(e, t) {
    return (
...
class __PRIVATE_MemoryMutationQueue {
  ...
  addMutationBatch(e, t, n, i) {
    ...
    for (const t of i)
      (this.Sr = this.Sr.add(new __PRIVATE_DocReference(t.key, s))),
  ...
  getHighestUnacknowledgedBatchId() {
    return PersistencePromise.resolve(
      0 === this.mutationQueue.length ? -1 : this.wr - 1
    );
  }
  getAllMutationBatches(e) {
  ...
  getAllMutationBatchesAffectingQuery(e, t) {
    ...
    let u = new SortedSet(__PRIVATE_primitiveComparator);
    return (
      this.Sr.forEachWhile((e) => {
        const t = e.key.path;
        return !!n.isPrefixOf(t) && (t.length === i && (u = u.add(e.yr)), !0);
      }, o),
      PersistencePromise.resolve(this.Cr(u))
    );
  }
  Cr(e) {
    const t = [];
  ...
  removeMutationBatch(e, t) {
    __PRIVATE_hardAssert(0 === this.vr(t.batchId, "removed")),
  ...
  applyChanges(e) {
    ...
    return (
      this.changes.forEach((n, i) => {
        i.isValidDocument()
          ? t.push(this.ur.addEntry(e, i))
          : this.ur.removeEntry(n);
      }),
      PersistencePromise.waitFor(t)
    );
  }
...
class __PRIVATE_MemoryTargetCache {
  constructor(e) {
    (this.persistence = e),
      ...
      (this.targetCount = 0),
      (this.Lr = __PRIVATE_TargetIdGenerator.Bn());
  }
  forEachTarget(e, t) {
  ...
  Qn(e) {
    ...
    t > this.highestTargetId &&
      ((this.Lr = new __PRIVATE_TargetIdGenerator(t)),
  ...
  removeTargetData(e, t) {
    return (
      this.Or.delete(t.target),
      this.Br.mr(t.targetId),
      (this.targetCount -= 1),
      PersistencePromise.resolve()
    );
  }
...
class __PRIVATE_MemoryPersistence {
  ...
  runTransaction(e, t, n) {
    ...
    const i = new __PRIVATE_MemoryTransaction(this.qr.next());
    return (
      this.referenceDelegate.Wr(),
      n(i)
        .next((e) => this.referenceDelegate.Gr(i).next(() => e))
        .toPromise()
  ...
  zr(e, t) {
    return PersistencePromise.or(
      Object.values(this.kr).map((n) => () => n.containsKey(e, t))
    );
  }
}
...
class __PRIVATE_MemoryLruDelegate {
  ...
  Yn(e, t) {
    return PersistencePromise.forEach(this.Xr, (n, i) =>
      this.tr(e, n, i).next((e) => (e ? PersistencePromise.resolve() : t(i)))
    );
  }
  removeTargets(e, t, n) {
  ...
  markPotentiallyOrphaned(e, t) {
    return (
      this.Xr.set(t, e.currentSequenceNumber), PersistencePromise.resolve()
    );
  }
  removeTarget(e, t) {
    const n = t.withSequenceNumber(e.currentSequenceNumber);
  ...
  addReference(e, t, n) {
    return (
      this.Xr.set(n, e.currentSequenceNumber), PersistencePromise.resolve()
    );
  }
  removeReference(e, t, n) {
    return (
...
class __PRIVATE_SchemaConverter {
  ...
  B(e, t, n, i) {
    ...
    return (
      ...
      n < 7 && i >= 7 && (o = o.next(() => this.ni(s))),
      n < 8 && i >= 8 && (o = o.next(() => this.ri(e, s))),
      n < 9 &&
        i >= 9 &&
        (o = o.next(() => {
    ...
    return n.G().next((e) => {
      ...
      return (
        ...
        PersistencePromise.forEach(n, (e, n) => {
          const o = new User(n),
            u = __PRIVATE_IndexedDbDocumentOverlayCache.Pt(this.serializer, o),
            l = s.getIndexManager(o),
            _ = __PRIVATE_IndexedDbMutationQueue.Pt(
              o,
              this.serializer,
              l,
              s.referenceDelegate
...
function __PRIVATE_createQueryCache(e) {
  e
    .createObjectStore("targetDocuments", { keyPath: Xe })
    .createIndex("documentTargetsIndex", Je, { unique: !0 }),
    e
...
class __PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, i, s, o, u, l, _, h, d = 15) {
    if (
      ...
      !__PRIVATE_IndexedDbPersistence.C())
    )
      throw new FirestoreError(
        $e.UNIMPLEMENTED,
    ...
    (this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, i)),
      ...
      (this.Ur = new __PRIVATE_IndexedDbBundleCache()),
      this.window && this.window.localStorage
        ? (this.Ai = this.window.localStorage)
        : ((this.Ai = null),
          !1 === h &&
            __PRIVATE_logError(
    ...
    return this.runTransaction(
      ...
      (e) =>
        __PRIVATE_clientMetadataStore(e)
          ...
          .next(() => {
            if (this.isPrimary)
              return this.pi(e).next((e) => {
                e ||
                  ((this.isPrimary = !1),
                  this._i.enqueueRetryable(() => this.di(!1)));
              });
          })
          .next(() => this.yi(e))
          .next((t) =>
      ...
      .then((e) => {
        this.isPrimary !== e && this._i.enqueueRetryable(() => this.di(e)),
          (this.isPrimary = e);
      });
  }
  pi(e) {
    return __PRIVATE_primaryClientStore(e)
      .get("owner")
      .next((e) => PersistencePromise.resolve(this.bi(e)));
  }
  Di(e) {
  ...
  async Ci() {
    ...
    this.Pi = this._i.enqueueAfterDelay("client_metadata_refresh", 4e3, () =>
      this.Ri()
        .then(() => this.Ci())
        .then(() => this.fi())
    );
    ...
    return this.ui
      ...
      : __PRIVATE_primaryClientStore(e)
          ...
          .next((t) => {
            if (
              null !== t &&
              this.vi(t.leaseTimestampMs, 5e3) &&
              !this.xi(t.ownerId)
            ) {
  ...
  async shutdown() {
    (this.Qr = !1),
      this.Oi(),
      this.Pi && (this.Pi.cancel(), (this.Pi = null)),
      this.Ni(),
      this.Bi(),
  ...
  ki() {
    return this.runTransaction("getActiveClients", "readonly", (e) =>
      __PRIVATE_clientMetadataStore(e)
        .G()
        .next((e) => this.Fi(e, 18e5).map((e) => e.clientId))
    );
  }
  get started() {
    return this.Qr;
  ...
  getMutationQueue(e, t) {
    return __PRIVATE_IndexedDbMutationQueue.Pt(
      e,
      this.serializer,
      t,
      this.referenceDelegate
    ...
    return this.Ei.runTransaction(
      ...
      (i) => (
        (o = new __PRIVATE_IndexedDbTransaction(
          i,
          this.qr ? this.qr.next() : __PRIVATE_ListenSequence.ae
        )),
        "readwrite-primary" === t
          ? this.pi(o)
              .next((e) => !!e || this.yi(o))
  ...
  Vi() {
    null !== this.document &&
      ...
      this.document.addEventListener("visibilitychange", this.hi),
      (this.inForeground = "visible" === this.document.visibilityState));
  }
  Ni() {
    this.hi &&
      (this.document.removeEventListener("visibilitychange", this.hi),
      (this.hi = null));
  }
  mi() {
    var e;
...
class __PRIVATE_LocalViewChanges {
  constructor(e, t, n, i) {
    (this.targetId = e), (this.fromCache = t), (this.Qi = n), (this.Ki = i);
  }
  static $i(e, t) {
    let n = __PRIVATE_documentKeySet(),
...
class __PRIVATE_QueryEngine {
  constructor() {
    (this.Ui = !1), (this.Wi = !1), (this.Gi = 100), (this.zi = 8);
  }
  initialize(e, t) {
  ...
  getDocumentsMatchingQuery(e, t, n, i) {
    ...
    return this.Hi(e, t)
      ...
      .next(() => {
        ...
        return this.Yi(e, t, n).next((i) => {
          if (((s.result = i), this.Wi)) return this.Zi(e, t, n, i.size);
        });
      })
      .next(() => s.result);
  }
  Zi(e, t, n, i) {
    return n.documentReadCount < this.Gi
      ? (__PRIVATE_getLogLevel() <= l.DEBUG &&
          __PRIVATE_logDebug(
            "QueryEngine",
      ...
      0 === i
        ...
        : (null !== t.limit &&
          ...
          this.indexManager.getDocumentsMatchingTarget(e, n).next((i) => {
            ...
            return this.ji.getDocuments(e, s).next((i) =>
              this.indexManager.getMinOffset(e, n).next((n) => {
                const o = this.Xi(t, i);
                return this.es(t, o, s, n.readTime)
                  ? this.Hi(e, __PRIVATE_queryWithLimit(t, null, "F"))
                  : this.ts(e, o, t, n);
              })
            );
          }))
  ...
  ts(e, t, n, i) {
    return this.ji.getDocumentsMatchingQuery(e, n, i).next(
      (e) => (
        t.forEach((t) => {
          e = e.insert(t.key, t);
        }),
...
class __PRIVATE_LocalStoreImpl {
  constructor(e, t, n, i) {
    (this.persistence = e),
      ...
      (this.ss = new ObjectMap(
        (e) => __PRIVATE_canonifyTarget(e),
        __PRIVATE_targetEquals
      )),
      (this.os = new Map()),
      (this._s = e.getRemoteDocumentCache()),
      (this.Kr = e.getTargetCache()),
      (this.Ur = e.getBundleCache()),
      this.us(n);
  }
  us(e) {
    (this.documentOverlayCache = this.persistence.getDocumentOverlayCache(e)),
      ...
      this._s.setIndexManager(this.indexManager),
      this.ns.initialize(this.localDocuments, this.indexManager);
  }
  collectGarbage(e) {
    return this.persistence.runTransaction(
      "Collect garbage",
      "readwrite-primary",
      (t) => e.collect(t, this.rs)
    );
  }
}
  ...
  return await n.persistence.runTransaction(
    ...
    (e) => {
      ...
      return n.mutationQueue
        .getAllMutationBatches(e)
        .next(
          (s) => ((i = s), n.us(t), n.mutationQueue.getAllMutationBatches(e))
        )
        .next((t) => {
          const s = [],
            o = [];
          ...
          return n.localDocuments
            .getDocuments(e, u)
            .next((e) => ({ cs: e, removedBatchIds: s, addedBatchIds: o }));
        });
    }
  );
}
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence
    .runTransaction("Allocate target", "readwrite", (e) => {
      let i;
      return n.Kr.getTargetData(e, t).next((s) =>
        s
          ? ((i = s), PersistencePromise.resolve(i))
          : n.Kr.allocateTargetId(e).next(
              (s) => (
                (i = new TargetData(
                  t,
                  s,
    ...
    .then((e) => {
      const i = n.rs.get(e.targetId);
      return (
        (null === i || e.snapshotVersion.compareTo(i.snapshotVersion) > 0) &&
          ((n.rs = n.rs.insert(e.targetId, e)), n.ss.set(t, e.targetId)),
        e
      );
    });
}
async function __PRIVATE_localStoreReleaseTarget(e, t, n) {
  ...
  (i.rs = i.rs.remove(t)), i.ss.delete(s.target);
}
  ...
  return i.persistence.runTransaction("Execute query", "readwrite", (e) =>
    (function __PRIVATE_localStoreGetTargetData(e, t, n) {
      const i = __PRIVATE_debugCast(e),
        s = i.ss.get(n);
      return void 0 !== s
        ? PersistencePromise.resolve(i.rs.get(s))
      ...
      .next(() =>
        i.ns.getDocumentsMatchingQuery(
          e,
          t,
...
function __PRIVATE_setMaxReadTime(e, t, n) {
  let i = e.os.get(t) || SnapshotVersion.min();
  n.forEach((e, t) => {
...
class __PRIVATE_WebStorageSharedClientState {
  constructor(e, t, n, i, s) {
    (this.window = e),
      ...
      (this.ys = new SortedMap(__PRIVATE_primitiveComparator)),
      (this.started = !1),
      (this.ws = []);
    const o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    (this.storage = this.window.localStorage),
      (this.currentUser = s),
      (this.Ss = createWebStorageClientStateKey(this.persistenceKey, this.fs)),
      (this.bs = (function createWebStorageSequenceNumberKey(e) {
        return `firestore_sequence_number_${e}`;
      })(this.persistenceKey)),
      (this.ys = this.ys.insert(this.fs, new __PRIVATE_LocalClientState())),
      (this.Ds = new RegExp(`^firestore_clients_${o}_([^_]*)$`)),
      (this.Cs = new RegExp(`^firestore_mutations_${o}_(\\d+)(?:_(.*))?$`)),
      (this.vs = new RegExp(`^firestore_targets_${o}_(\\d+)$`)),
      (this.Fs = (function createWebStorageOnlineStateKey(e) {
        return `firestore_online_state_${e}`;
      })(this.persistenceKey)),
      (this.Ms = (function createBundleLoadedKey(e) {
  ...
  shutdown() {
    this.started &&
      (this.window.removeEventListener("storage", this.gs),
      this.removeItem(this.Ss),
      (this.started = !1));
  }
  getItem(e) {
  ...
  Ks(e) {
    const t = { clientId: this.fs, onlineState: e };
  ...
  Ws(e, t) {
    const n = t ? this.ys.insert(e, t) : this.ys.remove(e),
      i = this.Bs(this.ys),
      s = this.Bs(n),
      o = [],
      u = [];
...
class __PRIVATE_MemorySharedClientState {
  constructor() {
    (this.ro = new __PRIVATE_LocalClientState()),
      (this.io = {}),
      (this.onlineStateHandler = null),
      (this.sequenceNumberHandler = null);
  }
...
class __PRIVATE_WebChannelConnection extends class __PRIVATE_RestConnection {
  constructor(e) {
    ...
    (this.po = t + "://" + e.host),
      (this.yo = `projects/${n}/databases/${i}`),
      (this.wo =
  ...
  Mo(e, t, n) {
    const i = __PRIVATE_generateUniqueDebugId(),
      s = [this.po, "/", "google.firestore.v1.Firestore", "/", e, "/channel"],
      o = new Od(),
      u = Mb(),
      l = {
    ...
    void 0 !== _ && (l.longPollingTimeout = Math.round(1e3 * _)),
      ...
      this.Co(l.initMessageHeaders, t, n),
    ...
    return (
      __PRIVATE_unguardedEventListen(d, Ne.EventType.OPEN, () => {
...
class __PRIVATE_ExponentialBackoff {
  ...
  Qo(e) {
    this.cancel();
    const t = Math.floor(this.Bo + this.Ko()),
      n = Math.max(0, Date.now() - this.ko),
      i = Math.max(0, t - n);
    i > 0 &&
      __PRIVATE_logDebug(
        "ExponentialBackoff",
        `Backing off for ${i} ms (base delay: ${this.Bo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`
      ),
...
class __PRIVATE_PersistentStream {
  constructor(e, t, n, i, s, o, u, l) {
    (this._i = e),
      ...
      (this.jo = null),
      (this.stream = null),
      (this.Ho = new __PRIVATE_ExponentialBackoff(e, t));
  }
  Jo() {
  ...
  e_() {
    this.Yo() &&
      null === this.zo &&
      (this.zo = this._i.enqueueAfterDelay(this.Uo, 6e4, () => this.t_()));
  }
  n_(e) {
    this.r_(), this.stream.send(e);
  }
  async t_() {
    if (this.Yo()) return this.close(0);
  }
  r_() {
  ...
  async close(e, t) {
    this.r_(),
      ...
      null !== this.stream &&
        (this.s_(), this.stream.close(), (this.stream = null)),
      (this.state = e),
  ...
  __(e, t) {
    ...
    (this.stream = this.u_(e, t)),
      this.stream.Io(() => {
        n(
          () => (
            (this.state = 2),
            (this.jo = this._i.enqueueAfterDelay(
              this.Wo,
              1e4,
              () => (this.Yo() && (this.state = 3), Promise.resolve())
            )),
            this.listener.Io()
          )
        );
  ...
  bo(e, t, n) {
    return (
      ...
      Promise.all([
        ...
        .then(([i, s]) => this.connection.bo(e, t, n, i, s))
        .catch((e) => {
  ...
  Fo(e, t, n, i) {
    return (
      ...
      Promise.all([
        ...
        .then(([s, o]) => this.connection.Fo(e, t, n, s, o, i))
        .catch((e) => {
          throw "FirebaseError" === e.name
            ? (e.code === $e.UNAUTHENTICATED &&
                (this.authCredentials.invalidateToken(),
...
class __PRIVATE_OnlineStateTracker {
  ...
  y_() {
    0 === this.f_ &&
      (this.w_("Unknown"),
      (this.g_ = this.asyncQueue.enqueueAfterDelay(
        "online_state_timeout",
        1e4,
        () => (
          (this.g_ = null),
          this.S_("Backend didn't respond within 10 seconds."),
          this.w_("Offline"),
          Promise.resolve()
        )
      )));
  ...
  set(e) {
    this.D_(), (this.f_ = 0), "Online" === e && (this.p_ = !1), this.w_(e);
  }
  w_(e) {
  ...
  S_(e) {
    ...
    this.p_
      ? (__PRIVATE_logError(t), (this.p_ = !1))
...
class __PRIVATE_RemoteStoreImpl {
  constructor(e, t, n, i, s) {
    (this.localStore = e),
      ...
      (this.O_ = new __PRIVATE_OnlineStateTracker(n, i));
  }
}
async function __PRIVATE_enableNetworkInternal(e) {
  if (__PRIVATE_canUseNetwork(e)) for (const t of e.M_) await t(!0);
}
async function __PRIVATE_disableNetworkInternal(e) {
  for (const t of e.M_) await t(!1);
}
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.v_.has(t.targetId) ||
    (n.v_.set(t.targetId, t),
    __PRIVATE_shouldStartWatchStream(n)
      ? __PRIVATE_startWatchStream(n)
      : __PRIVATE_ensureWatchStream(n).Yo() &&
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.v_.delete(t),
    i.Yo() && __PRIVATE_sendUnwatchRequest(n, t),
    0 === n.v_.size &&
      (i.Yo() ? i.e_() : __PRIVATE_canUseNetwork(n) && n.O_.set("Unknown"));
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  __PRIVATE_cleanUpWatchStreamState(e),
    __PRIVATE_shouldStartWatchStream(e)
      ? (e.O_.b_(t), __PRIVATE_startWatchStream(e))
      : e.O_.set("Unknown");
}
          ...
          return (
            n.targetChanges.forEach((n, i) => {
              if (n.resumeToken.approximateByteSize() > 0) {
                const s = e.v_.get(i);
                s && e.v_.set(i, s.withResumeToken(n.resumeToken, t));
              }
            }),
...
async function __PRIVATE_fillWritePipeline(e) {
  ...
  let i = t.C_.length > 0 ? t.C_[t.C_.length - 1].batchId : -1;
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t &&
    __PRIVATE_ensureWriteStream(e).I_ &&
    (await (async function __PRIVATE_handleWriteError(e, t) {
      if (
        ...
        const n = e.C_.shift();
        __PRIVATE_ensureWriteStream(e).Xo(),
          await __PRIVATE_executeWithRecovery(e, () =>
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  t
    ? (n.F_.delete(2), await __PRIVATE_enableNetworkInternal(n))
    : t ||
      (n.F_.add(2),
      await __PRIVATE_disableNetworkInternal(n),
      n.O_.set("Unknown"));
...
function __PRIVATE_ensureWriteStream(e) {
  return (
    e.L_ ||
      ...
      e.M_.push(async (t) => {
        t
          ? (e.L_.Xo(), await __PRIVATE_fillWritePipeline(e))
          : (await e.L_.stop(),
            e.C_.length > 0 &&
              (__PRIVATE_logDebug(
                "RemoteStore",
                `Stopping write stream with ${e.C_.length} pending writes`
              ),
              (e.C_ = [])));
      })),
    e.L_
  ...
  track(e) {
    ...
    n
      ? 0 !== e.type && 3 === n.type
        ...
        : 3 === e.type && 1 !== n.type
        ? (this.k_ = this.k_.insert(t, { type: n.type, doc: e.doc }))
        : 2 === e.type && 2 === n.type
        ? (this.k_ = this.k_.insert(t, { type: 2, doc: e.doc }))
        : 2 === e.type && 0 === n.type
        ? (this.k_ = this.k_.insert(t, { type: 0, doc: e.doc }))
        : 1 === e.type && 0 === n.type
        ? (this.k_ = this.k_.remove(t))
        : 1 === e.type && 2 === n.type
        ? (this.k_ = this.k_.insert(t, { type: 1, doc: n.doc }))
        : 0 === e.type && 1 === n.type
        ? (this.k_ = this.k_.insert(t, { type: 2, doc: e.doc }))
        : fail()
      : (this.k_ = this.k_.insert(t, e));
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  n.queries.set(i, o),
    o.listeners.push(t),
    t.U_(n.onlineState),
    o.Q_ && t.W_(o.Q_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e of t) {
    const t = e.query,
      s = n.queries.get(t);
    if (s) {
      for (const t of s.listeners) t.W_(e) && (i = !0);
      s.Q_ = e;
    }
  }
...
class __PRIVATE_QueryListener {
  ...
  W_(e) {
    ...
    return (
      this.z_
        ? this.H_(e) && (this.G_.next(e), (t = !0))
        : this.J_(e, this.onlineState) && (this.Y_(e), (t = !0)),
      (this.j_ = e),
      t
    );
  }
...
class __PRIVATE_BundleLoader {
  ...
  na(e) {
    ...
    if (e.X_.namedQuery) this.queries.push(e.X_.namedQuery);
      ...
      this.documents.push({ metadata: e.X_.documentMetadata }),
        e.X_.documentMetadata.exists || ++t;
      const n = ResourcePath.fromString(e.X_.documentMetadata.name);
      this.collectionGroups.add(n.get(n.length - 2));
    } else
      e.X_.document &&
        ((this.documents[this.documents.length - 1].document = e.X_.document),
        ++t);
  ...
  async complete() {
    const e = await (async function __PRIVATE_localStoreApplyBundledDocuments(
        ...
        const l = s._s.newChangeBuffer({ trackRemovals: !0 }),
        ...
        return s.persistence.runTransaction(
          ...
          (e) =>
            __PRIVATE_populateDocumentChangeBuffer(e, l, u)
              .next((t) => (l.apply(e), t))
              .next((t) =>
                s.Kr.removeMatchingKeysForTargetId(e, _.targetId)
                  .next(() => s.Kr.addMatchingKeys(e, o, _.targetId))
                  .next(() =>
                    s.localDocuments.getLocalViewOfDocuments(e, t.ls, t.hs)
                  )
                  .next(() => t.ls)
              )
        );
    ...
    return (
      ...
      { progress: this.progress, ia: this.collectionGroups, sa: e }
    );
  }
}
...
class __PRIVATE_View {
  constructor(e, t) {
    (this.query = e),
      ...
      (this.ua = __PRIVATE_newQueryComparator(e)),
  ...
  ha(e, t) {
        ...
        h && d
          ? h.data.isEqual(d.data)
            ...
            : this.Ia(h, d) ||
              ...
              (g = !0),
              ((l && this.ua(d, l) > 0) || (_ && this.ua(d, _) < 0)) &&
                (u = !0))
          : !h && d
    ...
    return { ca: o, Pa: n, es: u, mutatedKeys: s };
  }
  Ia(e, t) {
    return (
  ...
  applyChanges(e, t, n) {
    ...
    s.sort(
      ...
      this.da(n);
    const o = t ? this.Ta() : [],
      u = 0 === this.aa.size && this.current ? 1 : 0,
      l = u !== this._a;
    return (
      (this._a = u),
      0 !== s.length || l
  ...
  da(e) {
    e &&
      (e.addedDocuments.forEach((e) => (this.oa = this.oa.add(e))),
      e.modifiedDocuments.forEach((e) => {}),
      e.removedDocuments.forEach((e) => (this.oa = this.oa.delete(e))),
...
class __PRIVATE_SyncEngineImpl {
  constructor(e, t, n, i, s, o) {
    (this.localStore = e),
      ...
      (this.Sa = new Map()),
      (this.ba = new __PRIVATE_ReferenceSet()),
      (this.Da = {}),
      (this.Ca = new Map()),
      (this.va = __PRIVATE_TargetIdGenerator.Ln()),
      (this.onlineState = "Unknown"),
      (this.Fa = void 0);
  }
  get isPrimaryClient() {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, i, s) {
  ...
  __PRIVATE_updateTrackedLimbos(e, n, h.Ea);
    ...
    const e = await (function __PRIVATE_localStoreApplyRemoteEventToLocalCache(
      ...
      return n.persistence
        .runTransaction("Apply remote event", "readwrite-primary", (e) => {
          const o = n._s.newChangeBuffer({ trackRemovals: !0 });
          s = n.rs;
          const u = [];
          t.targetChanges.forEach((o, l) => {
            ...
            if (!_) return;
            u.push(
              n.Kr.removeMatchingKeys(e, o.removedDocuments, l).next(() =>
                n.Kr.addMatchingKeys(e, o.addedDocuments, l)
              )
            );
          ...
          if (
            ...
            const t = n.Kr.getLastRemoteSnapshotVersion(e).next((t) =>
    ...
    t.targetChanges.forEach((e, t) => {
      ...
      i &&
        ...
        e.addedDocuments.size > 0
          ...
          ? __PRIVATE_hardAssert(i.ma)
          : e.removedDocuments.size > 0 &&
            (__PRIVATE_hardAssert(i.ma), (i.ma = !1)));
    }),
    ...
    i.ga.forEach((n, i) => {
      ...
      (function __PRIVATE_eventManagerOnOnlineStateChange(e, t) {
        ...
        n.queries.forEach((e, n) => {
          for (const e of n.listeners) e.U_(t) && (i = !0);
        }),
          i && __PRIVATE_raiseSnapshotsInSyncEvent(n);
      })(i.eventManager, t),
      e.length && i.fa.c_(e),
      ...
      return n.persistence.runTransaction(
        ...
        (e) => {
          const i = t.batch.keys(),
            s = n._s.newChangeBuffer({ trackRemovals: !0 });
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const i of n)
    i instanceof __PRIVATE_AddedLimboDocument
      ? (e.ba.addReference(i.key, t), __PRIVATE_trackLimboChange(e, i))
      : i instanceof __PRIVATE_RemovedLimboDocument
      ? (__PRIVATE_logDebug(
          "SyncEngine",
          "Document no longer in limbo: " + i.key
        ),
        e.ba.removeReference(i.key, t),
        e.ba.containsKey(i.key) || __PRIVATE_removeLimboTarget(e, i.key))
      : fail();
}
...
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.ya.size > 0 && e.wa.size < e.maxConcurrentLimboResolutions; ) {
    ...
    const n = new DocumentKey(ResourcePath.fromString(t)),
      i = e.va.next();
    e.Sa.set(i, new LimboResolution(n)),
      (e.wa = e.wa.insert(n, i)),
      ...
      u.push(
        i.Ma(l, t, n).then((e) => {
          if (
            ...
            s.push(e);
            const t = __PRIVATE_LocalViewChanges.$i(l.targetId, e);
            o.push(t);
          }
        })
      );
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  ...
  if (!n.currentUser.isEqual(t)) {
    ...
    (n.currentUser = t),
      ...
      await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e.cs);
  }
}
...
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  const n = __PRIVATE_debugCast(e),
    ...
    s = t.view.Ra(i);
  return (
    n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, s.Ea), s
  );
}
...
function __PRIVATE_ensureWatchCallbacks(e) {
  ...
  return (
    ...
    (t.fa.c_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager)),
    (t.fa.xa = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager)),
    t
  );
}
...
class __PRIVATE_IndexedDbOfflineComponentProvider extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e),
      await this.Na.initialize(this, e),
      await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Na.syncEngine),
      await __PRIVATE_fillWritePipeline(this.Na.remoteStore),
      await this.persistence.gi(
        () => (
          this.gcScheduler &&
            ...
            n.pa.forEach((i, s) => {
              ...
              (function __PRIVATE_resetLimboDocuments(e) {
                ...
                t.Sa.forEach((e, n) => {
                  ...
                  t.ba.gr(),
                  (t.Sa = new Map()),
                  (t.wa = new SortedMap(DocumentKey.comparator));
              })(n),
              (n.Fa = !1),
              await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, !1);
          }
        })(this.Na.syncEngine, e),
          this.gcScheduler &&
...
class __PRIVATE_BundleReaderImpl {
  constructor(e, t) {
    (this.ka = e),
      ...
      (this.qa = (function __PRIVATE_newTextDecoder() {
        return new TextDecoder("utf-8");
      })()),
      this.Qa().then(
        (e) => {
          e && e.ea()
            ? this.metadata.resolve(e.X_.metadata)
  ...
  async Ka() {
    ...
    const e = this.Wa();
    e < 0 &&
      this.$a("Reached the end of bundle when a length string is expected.");
  ...
  async Ua(e) {
    for (; this.buffer.length < e; )
      (await this.Ga()) &&
        this.$a("Reached the end of bundle when more is expected.");
  ...
  async lookup(e) {
    ...
    const t = await (async function __PRIVATE_invokeBatchGetDocumentsRpc(e, t) {
      const n = __PRIVATE_debugCast(e),
        ...
        o = await n.Fo("BatchGetDocuments", i, s, t.length),
        u = new Map();
      o.forEach((e) => {
...
class __PRIVATE_TransactionRunner {
  ...
  Ja(e) {
    this.za > 0 && this.Ya(e)
      ? ((this.za -= 1),
        this.asyncQueue.enqueueAndForget(() => (this.ja(), Promise.resolve())))
          ...
          return (
            ...
            await (function __PRIVATE_localStoreSaveBundle(e, t) {
              ...
              return n.persistence.runTransaction(
                "Save bundle",
                "readwrite",
                (e) => n.Ur.saveBundleMetadata(e, t)
              );
            })(e.localStore, i),
            n._completeWith(u.progress),
            Promise.resolve(u.ia)
          );
        } catch (e) {
          return (
...
class __PRIVATE_AsyncQueueImpl {
  constructor() {
    (this.Za = Promise.resolve()),
      ...
      (this.iu = !1),
      (this.su = []),
      (this.Ho = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry")),
      (this.ou = () => {
        const e = getDocument();
        e &&
          __PRIVATE_logDebug(
    ...
    e &&
      ...
      e.addEventListener("visibilitychange", this.ou);
  }
  get isShuttingDown() {
    return this.eu;
  }
  ...
  enterRestrictedMode(e) {
    if (!this.eu) {
      ...
      t &&
        ...
        t.removeEventListener("visibilitychange", this.ou);
    }
  }
  enqueue(e) {
    ...
    return e.asyncQueue.enqueue(async () => {
      ...
      return (
        ...
        (function __PRIVATE_remoteStoreEnableNetwork(e) {
          const t = __PRIVATE_debugCast(e);
          return t.F_.delete(0), __PRIVATE_enableNetworkInternal(t);
        })(n)
      );
    });
  })(ensureFirestoreConfigured((e = __PRIVATE_cast(e, Firestore))));
...
class __PRIVATE_ParseContextImpl {
  ...
  fu(e) {
    return this.Eu({ path: void 0, Ru: !0 });
  }
  gu(e) {
  ...
  Vu(e) {
    ...
    if (__PRIVATE_isWrite(this.Tu) && Mt.test(e))
...
function __PRIVATE_parseSetData(e, t, n, i, s, o = {}) {
  const u = e.wu(o.merge || o.mergeFields ? 2 : 0, t, n, s);
...
function __PRIVATE_createSentinelChildContext(e, t, n) {
  return new __PRIVATE_ParseContextImpl(
    { Tu: 3, yu: t.settings.yu, methodName: e._methodName, Ru: n },
    t.databaseId,
    t.serializer,
    t.ignoreUndefinedProperties
  );
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(this, e, !0),
      n = this.Su.map((e) => __PRIVATE_parseData(e, t)),
...
function __PRIVATE_parseQueryValue(e, t, n, i = !1) {
  return __PRIVATE_parseData(n, e.wu(i ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if ((t.path && t.fieldMask.push(t.path), e instanceof Array)) {
    ...
    return (function __PRIVATE_parseArray(e, t) {
      ...
      let i = 0;
      for (const s of e) {
        let e = __PRIVATE_parseData(s, t.fu(i));
...
function __PRIVATE_parseObject(e, t) {
  ...
  return (
    isEmpty(e)
      ...
      : forEach(e, (e, i) => {
          const s = __PRIVATE_parseData(i, t.Au(e));
          null != s && (n[e] = s);
        }),
    { mapValue: { fields: n } }
  );
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (
    ...
    throw "an object" === i ? t.gu(e + " a custom object") : t.gu(e + " " + i);
  }
}
          ...
          i.resolve(
            (async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
              ...
              const s = __PRIVATE_debugCast(e),
                ...
                l = o.parent;
              s.connection.So || delete o.parent;
              const _ = (await s.Fo("RunAggregationQuery", l, o, 1)).filter(
                (e) => !!e.result
              );
